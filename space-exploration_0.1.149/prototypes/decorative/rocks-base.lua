--NOTE: this is different from the alien biomes data
local rock_coverage_multiplier = 6
local rock_max_prob_multiplier = 2
return {
{
  name = "rock-huge",
  type = "simple-entity",
  ...
  minable =
  {
    ...
    mining_time = 1.5,
    results = {
      {name = "stone", probability = 1, amount_min = 10, amount_max = 20},
      {name = "iron-ore", probability = 1, amount_min = 0, amount_max = 20},
      {name = "copper-ore", probability = 1, amount_min = 0, amount_max = 10},
    },
    --count = 200
  },
  loot =
  {
    ...
    {item = "iron-ore", probability = 1, amount_min = 10, amount_max = 20},
    {item = "copper-ore", probability = 1, amount_min = 10, amount_max = 20},
  },
...
},
{
  ...
  minable =
  {
    ...
    mining_time = 1,
    results = {
      {name = "stone", probability = 1, amount_min = 5, amount_max = 10},
      {name = "iron-ore", probability = 1, amount_min = 0, amount_max = 1},
    },
  },
  loot =
  {
    {item = "stone", probability = 1, count_min = 5, count_max = 10},
      {item = "iron-ore", probability = 1, count_min = 0, count_max = 1}
  },
  count_as_rock_for_filtered_deconstruction = true,
  mined_sound = { filename = "__base__/sound/deconstruct-bricks.ogg" },
  vehicle_impact_sound =  { filename = "__base__/sound/car-stone-impact.ogg", volume = 1.0 },
...
},
{
  ...
  render_layer = "decorative",
  autoplace = {
    coverage = 0.010 * rock_coverage_multiplier,
    max_probability = 0.5 * rock_max_prob_multiplier,
...
},
{
  ...
  minable =
  {
    ...
    mining_time = 1,
    results = {
      {name = "stone", amount_min = 5, amount_max = 10},
      {name = "copper-ore", amount_min = 0, amount_max = 1},
    },
  },
  loot =
  {
