...
make_recipe({
  ...
  icons = {
    ...
    { icon = data.raw.item["wood"].icon, scale = 0.5, shift = {-10, 10}, icon_size = 32 },
    { icon = data.raw.capsule["raw-fish"].icon, scale = 0.5, shift = {-10, 0}, icon_size = 32 },
  },
  always_show_made_in = true,
})
...
make_recipe({
  ...
  icons = {
    { icon = data.raw.item[data_util.mod_prefix .. "lifesupport-canister"].icon, scale = 1, icon_size = 32 },
    { icon = data.raw.item["coal"].icon, scale = 0.5, shift = {-10, 10}, icon_size = 32 },
  },
