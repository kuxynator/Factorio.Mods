...
data:extend({
  {
    ...
    minable = {mining_time = 0.2, result = data_util.mod_prefix .. "space-recycling-facility"},
    max_health = 1200,
    corpse = "big-remnants",
  ...
  },
  {
    ...
    icon_size = 32,
    flags = {"placeable-neutral","placeable-player", "player-creation"},
    minable = {mining_time = 0.2, result = data_util.mod_prefix .. "core-fragment-processor"},
    max_health = 1200,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
    alert_icon_shift = util.by_pixel(0, -12),
    ...
    animation =
    {
      ...
      {
        {
          filename = "__space-exploration-graphics__/graphics/entity/core-fragment-processor/sr/core-fragment-processor.png",
          priority = "high",
          width = 3840/8/2,
          height = 3584/8/2,
          frame_count = 64,
          ...
          animation_speed = 0.75,
          hr_version = data_util.hr({
            filename = "__space-exploration-hr-graphics__/graphics/entity/core-fragment-processor/hr/core-fragment-processor.png",
            priority = "high",
            width = 3840/8,
            height = 3584/8,
            frame_count = 64,
        ...
        {
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/core-fragment-processor/sr/core-fragment-processor-shadow.png",
          priority = "high",
          width = 694/2,
          height = 400/2,
          frame_count = 1,
          ...
          hr_version = data_util.hr({
            draw_as_shadow = true,
            filename = "__space-exploration-hr-graphics__/graphics/entity/core-fragment-processor/hr/core-fragment-processor-shadow.png",
            priority = "high",
            width = 694,
            height = 400,
            frame_count = 1,
    ...
    crafting_categories = {"core-fragment-processing"},
    crafting_speed = 1,
    energy_source =
    {
      type = "electric",
