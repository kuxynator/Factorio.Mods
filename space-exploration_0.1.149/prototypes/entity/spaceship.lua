...
local console_vertical = {
  layers =
  {
    {
      filename = "__space-exploration-graphics__/graphics/entity/spaceship-console/spaceship-console-vertical.png",
      priority = "high",
      width = 256,
      height = 288,
      frame_count = 1,
...
data:extend({
  ...
  antimatter_booster,
  {
    ...
    collision_box = {{-1.51, -1.3}, {1.51, 1.3}},
    selection_box = {{-1.95, -1.45}, {1.95, 1.45}},
    drawing_box = {{-1.6, -1.5}, {1.6, 1.5}},
    resistances =
    {
      { type = "poison", percent = 100 },
    ...
    --animation =  {
    sprites =  {
      east = console_vertical,
      west = console_vertical,
      north = console_horizontal,
      south = console_horizontal,
    },
    ...
    item_slot_count = 12,
    activity_led_sprites = blank_directions,
    activity_led_light =
    {
        intensity = 0.8,
        size = 1,
    ...
    equal_symbol_sprites = blank_directions,
    greater_or_equal_symbol_sprites = blank_directions,
    greater_symbol_sprites = blank_directions,
    less_or_equal_symbol_sprites = blank_directions,
    less_symbol_sprites = blank_directions,
    not_equal_symbol_sprites = blank_directions,
  },
  {
    type = "furnace",
