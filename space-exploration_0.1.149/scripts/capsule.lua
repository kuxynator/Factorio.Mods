        ...
        if space_capsule.launch_progress < animation_move_frame / animation_speed + 60 * 5 then
          ...
          if animation_frame == 1 and not space_capsule.sounds_frame_1 then
            ...
            space_capsule.rocket_sound = space_capsule.vehicle.surface.create_entity{
              name="sound-continous-silo-rocket", position=space_capsule.vehicle.position, target=space_capsule.vehicle, speed=0}
            space_capsule.vehicle.surface.create_entity{
              name="sound-silo-clamps-on", position=space_capsule.vehicle.position, target=space_capsule.vehicle, speed=0}
            space_capsule.vehicle.surface.create_entity{
              name="sound-machine-close", position=space_capsule.vehicle.position, target=space_capsule.vehicle, speed=0}

          end
          if animation_frame == 19 and not space_capsule.sounds_frame_19 then
            space_capsule.sounds_frame_19 = true
            space_capsule.vehicle.surface.create_entity{
              name="sound-train-breaks", position=space_capsule.vehicle.position, target=space_capsule.vehicle, speed=0}
          end
