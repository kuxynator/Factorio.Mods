...
function Landingpad.on_player_opened_changed(event)
  ...
  if opened_new and opened_new.valid and opened_gui_type_new == defines.gui_type.entity and opened_new.name == Landingpad.name_rocket_landing_pad then
    Landingpad.gui_open(player, Landingpad.from_entity(opened_new))
  else
...
Event.addListener("on_player_opened_changed", Landingpad.on_player_opened_changed, true)
