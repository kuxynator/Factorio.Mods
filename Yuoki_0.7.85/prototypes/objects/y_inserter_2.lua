data:extend(
{
	...
	
	{
		...
		minable = {hardness = 0.2, mining_time = 0.5, result = "y_inserter_diagonal"},
		max_health = 100,
	...
	
	{
		...
		stack = false,
		 icon_size = 32, icon =  "__Yuoki__/graphics/entity/inserters/ins_evade_right_icon.png",
		flags = {"placeable-neutral", "placeable-player", "player-creation"},
		minable = {hardness = 0.2, mining_time = 0.5, result = "y_inserter_evade_shortR"},
		max_health = 100,
		corpse = "small-remnants",
		vehicle_impact_sound =  { filename = "__base__/sound/car-metal-impact.ogg", volume = 0.65 },
		working_sound =
	...
	
	{
		...
		stack = false,
		 icon_size = 32, icon =  "__Yuoki__/graphics/entity/inserters/ins_evade_left_icon.png",
		flags = {"placeable-neutral", "placeable-player", "player-creation"},
		minable = {hardness = 0.2, mining_time = 0.5, result = "y_inserter_evade_shortL"},
		max_health = 100,
		corpse = "small-remnants",
		vehicle_impact_sound =  { filename = "__base__/sound/car-metal-impact.ogg", volume = 0.65 },
		working_sound =
